...
public class ControlModificarOpenB implements Initializable {
    ...
    private void guardar(ActionEvent event) throws SQLException {
        ...
        if (!jugadores.contains(j)) {
            ...
            if (this.jugador != null) {
                PreparedStatement ps = cnx.prepareStatement("update jugador set nombre = ?, FIDEID = ?, Pais = ?, CV = ?, Hotel = ? where FIDEID = ? and NomTorneo = 'OPEN B'");
