...
public class ControlJugadorOptaPremioOpenB implements Initializable {
    ObservableList<String> optados = FXCollections.observableArrayList("","Alojado","CM","SUB1400","SUB1600","SUB1800");
    //Mirar
    @FXML
